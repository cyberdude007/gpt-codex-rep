...
interface PartyMemberDao {
    ...
    @Query("SELECT * FROM party_members WHERE LOWER(displayName) LIKE '%' || :needle || '%' LIMIT :limit")
    suspend fun prefilterMembers(needle: String, limit: Int): List<PartyMemberEntity>
}
