...
class GlobalSearchTest {
    ...
    class StubTxDao : TransactionDao {
        ...
        override fun spendByCategory(start: Long, end: Long): Flow<List<com.splitpaisa.data.local.dao.CategorySliceRow>> = flowOf(emptyList())
        override fun monthlyTrend(start: Long, end: Long): Flow<List<com.splitpaisa.data.local.dao.MonthTrendRow>> = flowOf(emptyList())
        override fun budgetVsActual(start: Long, end: Long): Flow<List<com.splitpaisa.data.local.dao.BudgetBarRow>> = flowOf(emptyList())
        override fun topCategories(start: Long, end: Long, limit: Int): Flow<List<com.splitpaisa.data.local.dao.TopCatRow>> = flowOf(emptyList())
